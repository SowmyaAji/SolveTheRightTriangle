...
let cosList = [
    `You were flying a kite on a bluff, but you managed somehow to dump your kite into the lake below. You know that you've given out ${ num1 } feet of string. A surveyor tells you that the angle of declination from your position to the kite is ${ num2 } degrees. How high is the bluff where you and the surveyor are standing?`, `Suppose that from atop a vertical cliff a ship is spotted at an angle of depression of ${ num2 } degrees.  If  the distance from the top of the cliff to the ship is ${ num1}, how high is the cliff?`, `Your doll is at the top of a model roller coaster.  The angle of sight from her to you is ${ num2 } degrees. If the line of sight from you looking up at  her is  ${ num1 } feet long, how high is she from the ground?`, `A railroad crossing arm that is ${ num1 } feet long is stuck with an angle of elevation of ${ num2 } degrees. What is the length of its shadow on the road?`,   `A ${ num1 } meter long ladder leans against a building. If the ladder makes an angle of ${ num2 } degrees with the ground,how far from the wall is the base of the ladder?` 
]

let cos2List = [
    `Suppose that from the top of a vertical cliff a ship is spotted at an angle of depression of ${ num2 } degrees.  If the cliff is ${ num1 } feet high, what is the distance from the top of the cliff to the ship?`, `Your doll is at the top of a ${ num1 } feet  model roller coaster.  The angle of sight for her is ${ num2 } degrees. How long is the line of sight from you looking up at  her?`, `Legolas is standing ${ num1 } feet away from the wall at Helms Deep, looking at an angle of ${ num2 } to the top. He needs to run up that wall to the top. How far away is the top from his eyes right now?`
]
...
let arcCosList = [
    ...
    `Your doll is at the top of a model ${ num1 } feet high roller coaster.   If the line of sight from you looking up at  her is  ${ num2 } feet long, what is the angle she is looking down at you?`, `Gimli has climbed a wall at Helms Deep and is grimly looking down at the Orcs battering the gates with their log. If the wall is ${ num1 } feet hight and the distance from Gimli to the Orcs is ${ num2 } feet, what is Gimli's angle of sight?`
